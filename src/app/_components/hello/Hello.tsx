...
export default function Hello() {
  ...
  return (
    <section className="bg-[#0D1321] text-white px-6 py-16 md:p-[120px] justify-center items-center flex">
      <div className="flex flex-col md:flex-row mx-auto gap-10 items-center">


        {/* Content */}
        <div className="flex-1 md:hidden block pb-16">
        ...
        <div className="relative w-full md:w-1/2 flex-shrink-0 group ">
          <Image
            src={profileImage}
            alt={name}
            width={500}
